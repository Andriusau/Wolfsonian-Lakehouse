...
export default function MemoryMatch() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col font-sans selection:bg-mca-cyan selection:text-black">
      {/* Top Nav */}
      <nav className="sticky top-0 z-50 bg-[#0a0a0a]/90 backdrop-blur-md border-b border-slate-200 px-6 py-4 flex items-center justify-between">
              ...
              {cards.map((card, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute inset-0 w-full h-full [backface-visibility:hidden] bg-white/5 border border-slate-200 hover:border-mca-cyan/50 hover:bg-white/10 transition-colors duration-300 flex items-center justify-center rounded-sm shadow-2xl">
