...
OA        ('210', ['b', 'a'], 'full'),
OAOAOAOAOA        ('220', ['l', 'b', 'c', 'a'], 'full'), 
OAOAOA        ('222', ['b', 'a'], 'full'),
OAOAOAOAOAOAOAOA        ('240', ['s', 'e', '6', 'f', 'a', 'b', 'p', 'i', 'y', 'c', 'k', 'n', 'l', 'o'], 'full'),
OAOAOA        ('242', ['h', 'n', 'a', 'y', 'l', 'p', 'e', 'c', 'b'], 'full'), 
        ('245', ['s', 'f', '6', '2', 'a', 'd', '1', 'p', '3', 't', 'k', 'c', 'b', 'n', 'y', '7', '8', '9', 'h', 'x'], 'full'), 
OAOAOAOAOAOAOAOAOA        ('246', ['f', 'n', 'a', 'y', 'i', 'l', 'p', 'g', '6', 'c', 'b'], 'full'),
OAOAOA        ('247', ['f', 'a', 'h', 'g', 'b'], 'full'),
OAOA        ('249', ['a'], 'full'),
OAOAOAOAOA        ('250', ['b', 'a'], 'full'),
        ('255', ['c', 'a'], 'full'),
OAOA        ('260', ['s', 'e', '6', 'd', 'f', '1', 'g', 'a', 'u', 'p', '3', 'x', 'c', 'b', '5', 'z'], 'full'), 
OAOAOAOAOA        ('263', ['a'], 'full'),
OAOA        ('264', ['f', 'a', '3', 'e', '6', 'c', 'b'], 'full'),
OA        ('300', ['e', '6', '2', 'a', 'd', '1', '3', 'v', 'x', 'c', 'b', ' ', '7', '8', 'f', '4', 'i'], 'full'), 
OAOAOAOAOA        ('306', ['a'], 'full'),
        ('310', ['b', 'a'], 'full'),
OAOA        ('321', ['b', '5', 'a'], 'full'),
OAOAOAOA        ('334', ['2', 'a'], 'full'), 
        ('336', ['3', 'b', '2', 'a'], 'full'),
OA        ('337', ['3', 'b', '2', 'a'], 'full'),
        ('338', ['3', 'b', '2', 'a'], 'full'),
OAOA        ('340', ['m', 'a', 'd', '2', 'p', 'g', 'c', 'e'], 'full'),
OAOA        ('347', ['2', 'a'], 'full'),
        ('348', ['d', '2', 'c', 'a'], 'full'),
        ('350', ['a'], 'full'),
OA        ('351', ['b', 'c', 'a'], 'full'),
