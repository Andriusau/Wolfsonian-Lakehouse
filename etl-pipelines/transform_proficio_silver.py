...
if __name__ == "__main__":
    ...
    # ===============================================
    # Missing Objects Export (Gold Layer Comparison)
    # ===============================================
    ...
    logging.info(f"Found {missing_count} records in Proficio that are missing from Islandora.")

    logging.info("--- 💾 5. SAVE GOLD RESULTS ---")
    if not df_results.empty:
        ...
        # Rename the identifier column to 'field_identifier' for the final output if needed
        ...
        logging.info(f"Saved Gold Parquet results with limited columns to {OUTPUT_PARQUET}")
