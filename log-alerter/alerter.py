...
IGNORE_KEYWORDS = ["No Anthropic API key is set", "Suggested prompts generation failed", "qa_errors", "No such file or directory", "reset from ERROR state to: WAITING", "_error.yaml", "liquibase.changelog"]
