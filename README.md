...
|---|---|---|---|
| **Alma** | Ex Libris Library Management | 54,835 | Binary MARC (`.mrc`) parsing via PyMARC & Physical Item (`.csv`) mapping |
| **Proficio** | Museum Collection Database | 61,019 | Kerberos-authenticated SQL Server via ODBC |
| **Islandora** | Public Digital Archive | 268,062 | Paginated REST API with concurrent fetching |
| **Unified Gold Catalog** | Merged output | 115,854 | Alma + Proficio aligned and concatenated |
| **Normalized Gold Catalog** | Analytics-ready output | 115,854 | Harmonized genres, dates, creators & titles |
| **Records with Images** | Gold Catalog Filter | 55,605 | Distinct records possessing at least one valid image (a single record can have up to 1,000+ images for books/albums) |
| **Digital Images** | NFS Mounted Share | 341,324 | Parallel ingestion and JPEG compression |
