...
| **Records with Images** | Gold Catalog Filter | 55,592 | Distinct records possessing at least one valid image (a single record can have up to 1,000+ images for books/albums) |
| **Digital Images** | NFS Mounted Share | 341,290 | Parallel ingestion and JPEG compression |
