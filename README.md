...
| **Islandora** | Public Digital Archive | 267,948 | Paginated REST API with concurrent fetching |
...
| **Records with Images** | Gold Catalog Filter | 55,552 | Distinct records possessing at least one valid image (a single record can have up to 1,000+ images for books/albums) |
| **Digital Images** | NFS Mounted Share | 339,715 | Parallel ingestion and JPEG compression |
